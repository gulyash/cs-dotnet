...
namespace dotnetlab6.Kitchen
{
    ...
    public class Fridge : IEnumerable<Filling>, ICollection<Filling> //supporting interfaces ICollection & IEnumerable
    {
        ...
        /// </summary>
        [NonSerialized]
        private string fileName = "numconfig.txt";
        ...
        public void FillFridge() {
            ...
            try
            {
                ...
                //SortAsync(fillingShelf);
                //SortAsyncTask(fillingShelf, new Progress<int>(SortProgress));
            ...
            catch (Exception)
            {
                ...
                if (fileName == null) Console.WriteLine("file name is null, actually");
            }
        }
        ...
        private static void SortProgress(int progress)
        {
        ...
        /// <param name="progress"></param>
        /// <returns></returns>
        private async Task SortAsyncTask(List<Filling> fillings, IProgress<int> progress)
        {
            await Task.Run(() =>
            {
                var lastProg = -1;
